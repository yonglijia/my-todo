...
import { formatDate, isSameDayAs } from '../utils/dateUtils';
      ...
      <div style={{ marginBottom: '24px' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
            <div style={{ width: '40px', height: '40px', borderRadius: '8px', background: '#fff7e6', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              <SunOutlined style={{ fontSize: '20px', color: '#fa8c16' }} />
            </div>
            <div>
              <h1 style={{ margin: 0, fontSize: '24px', fontWeight: 600 }}>今天</h1>
              <p style={{ margin: 0, fontSize: '14px', color: '#8c8c8c' }}>{format(today, 'M月d日 EEEE', { locale: undefined })} · {todos.length} 个任务</p>
            </div>
          </div>
          <Button
            type="primary"
